...
class WalletRpcDeserializationTest extends TestCase
{
    ...
    public function testSweepSingle()
    {
        ...
        $response = SweepSingleResponse::fromJsonString($jsonResponse, "result", flags: JSON_BIGINT_AS_STRING);
        $responseFlat = $this->comparableJson($jsonResponse);
        $this->assertSame($responseFlat, $response->toJson());
    }
    ...
    {
        $jsonResponse = '{"in":[{"address":"77Vx9cs1VPicFndSVgYUvTdLCJEZw9h81hXLMYsjBCXSJfUehLa9TDW3Ffh45SQa7xb6dUs18mpNxfUhQGqfwXPSMrvKhVp","amount":200000000000,"amounts":[19223372036854775807,2,3],"confirmations":1,"double_spend_seen":false,"fee":21650200000,"height":153624,"locked":false,"note":"","destinations":[],"payment_id":"0000000000000000","subaddr_index":{"major":1,"minor":0},"subaddr_indices":[{"major":1,"minor":0}],"suggested_confirmations_threshold":1,"timestamp":1535918400,"txid":"c36258a276018c3a4bc1f195a7fb530f50cd63a4fa765fb7c6f7f49fc051762a","type":"in","unlock_time":0}],"out":[],"pending":[],"failed":[],"pool":[]}';
